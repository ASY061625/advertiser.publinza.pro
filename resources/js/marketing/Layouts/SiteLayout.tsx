...
export function SiteLayout({ children }: { children: ReactNode }) {
    return (
        <div className="flex min-h-screen flex-col bg-surface-card">
            <header className="sticky top-0 z-30 h-header border-b border-ink-300 bg-surface-card">
                <div className="mx-auto flex h-full max-w-content items-center justify-between px-6">
                    ...
                    <nav className="flex items-center gap-6">
                        ...
                        <a
                            ...
                            className="rounded-button bg-brand px-4 py-2 font-sora text-base font-medium text-white hover:bg-brand-700"
                        >
                            Sign in
                        </a>
                    </nav>
            ...
            <footer className="border-t border-ink-300 bg-surface-sunken">
